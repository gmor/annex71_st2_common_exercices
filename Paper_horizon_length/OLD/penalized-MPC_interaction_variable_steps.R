...
acf(mod_cop$model$hp_cop_l0-mod_cop$fitted.values)
...
time_to_predict <- as.POSIXct(x = "2019-01-05 10:00:00 UTC", tz = "UTC")#(x = "2018-12-19 23:00:00 UTC", tz = "UTC") #Time the MPC starts
time_to_predict_step <- as.POSIXct(x = "2019-01-03 00:00:00 UTC", tz = "UTC")#(x = "2018-12-19 14:00:00 UTC", tz = "UTC") #Start time of Modelica
...
max_time = as.numeric(seconds(as.POSIXct(x = "2019-01-07 00:00:00 UTC", tz = "UTC")) - #as.numeric(seconds(as.POSIXct(x = "2019-01-13 00:00:00 UTC", tz = "UTC"))
...
while (time <= max_time) { #<=
  ...
  if (time%%3600 == 0) {
    ...
    print(paste(df$ti[df$time == time_to_predict_step], RETURN$predv.ti_l0[1]))
  }
...
df_eval <- df_result[df_result$time_to_predict_step >= as.POSIXct(x = "2019-01-05 10:00:00 UTC", tz = "UTC") & df_result$time_to_predict_step <= as.POSIXct(x = "2019-01-12 23:00:00 UTC", tz = "UTC"),]
