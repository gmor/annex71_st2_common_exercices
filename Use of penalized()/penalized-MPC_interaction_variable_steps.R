...
result_cop <- calculate_model_cop(params, df, train_dates_1, output="model") #df
...
for (i in 1:horizon) {
  forecast_horit <- i
  R2_df_[i] <- 1-sum((ti_df[seq(forecast_horit, length(ti_df), horizon)]-ti_l0_df[seq(forecast_horit, length(ti_l0_df), horizon)])^2)/
...
by <- 2
features <- list("0"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "1"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "2"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "3"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "4"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "5"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "6"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "7"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "8"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "9"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "10"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "11"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "12"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "13"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "14"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "15"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "16"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "17"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "18"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "19"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "20"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "21"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "22"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "23"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "24"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "25"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "26"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "27"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "28"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "29"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "30"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "31"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "32"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "33"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "34"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "35"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "36"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "37"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "38"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "39"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "40"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "41"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "42"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "43"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "44"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "45"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "46"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete"),
                 "47"=list(levels = c(as.character(seq(from = min_hp_tset, to = max_hp_tset, by = by)), "NA"), class = "discrete")
                )
features <- features[1:horizon]

# Using min temperature as starting point
# params_hp_tset_24h = rep(x = min_hp_tset, times = 24)
params_hp_tset_24h = rep(x = min_hp_tset, times = horizon)
...
time_to_predict <- as.POSIXct(x = "2018-12-29 19:00:00 UTC", tz = "UTC")#(x = "2018-12-19 23:00:00 UTC", tz = "UTC") #Time the MPC starts
...
max_time = as.numeric(seconds(as.POSIXct(x = "2019-01-13 00:00:00 UTC", tz = "UTC")) - 
...
while (time <= max_time) {
  ...
  if (time%%3600 == 0) {
    ...
    df$ti[df$time == time_to_predict_step] = 
      sum(df_result_20s$Temp_aver[(length(df_result_20s$Temp_aver)-(3600/step_size)+1):(length(df_result_20s$Temp_aver))])/(3600/step_size)
...
ggplot() +
  ...
  geom_point(aes(x = df_result$time_to_predict_step, y = df_result$price/3)) +
  geom_point(aes(df_result$time_to_predict_step, ifelse(df_result$HPs_optim>0,df_result$price/3,NA), color = "green")) +
  geom_line(aes(df_result$time_to_predict_step, (df_result$Tsup_optim/4)+15, color = "grey"))
